  ...
  <section class="wizard-section">
    <div class="wizard-container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom overflow-hidden text-center">
        ...
        <div id="step-2" class="wizard-step d-none">
          ...
          <div class="wizard__button-box">
            ...
            <button class="btn btn-secondary" id="back-to-step-1">
              <svg style="margin-left: -1px;" width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
